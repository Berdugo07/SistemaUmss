            ...
            <div class="main p-3">
                <div class="container text-center" style="height: 400px; overflow-y: auto;">
                    ...
                    <form id="buscarForm" method="GET" style="margin-left: auto; margin-right: 20px; width: 300px;">
                        ...
                        <i class="bi bi-search" id="buscarIcono"></i> <!-- Icono de búsqueda -->
                    </form>
...
$(document).ready(function(){
    $('#buscarForm').submit(function(e){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                // Suponiendo que tienes una tabla con id "tablaAmbientes"
    ...
    // Resetear formulario y mostrar todos los ambientes al hacer clic en el botón de limpiar
    $('#resetButton').click(function(){
        $('#buscarForm')[0].reset(); // Resetear el formulario
        $.ajax({
            type: 'GET',
            url: 'buscar.php', // URL para obtener todos los ambientes
            dataType: 'json',
            success: function(data){
                // Actualizar la tabla con los resultados
                // Suponiendo que tienes una tabla con id "tablaAmbientes"
